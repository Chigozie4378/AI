            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu">LLM</span></li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span
                                    class="hide-menu">Train/Chat </span></a>
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="train_my_data.php" class="sidebar-link"><span
                                            class="hide-menu"> Train my Datas
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="chat.php" class="sidebar-link"><span
                                            class="hide-menu"> Chat with my Model
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="chat_general.php" class="sidebar-link"><span
                                            class="hide-menu"> Chat With General Model
                                        </span></a>
                                </li>
                            </ul>
                        </li>
